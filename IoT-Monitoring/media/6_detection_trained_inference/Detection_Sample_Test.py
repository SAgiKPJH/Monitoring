...
#   결과: out_sample\ 에 박스+골격 이미지 + 콘솔 요약
# ─────────────────────────────────────────────────────────────
r"""Detection_Sample_Test.py — 학습된 baby 모델로 학습 이미지 N개 랜덤 추론.
...
# ══════════════════════ 설정 (학습 모델) ══════════════════════
SRC_DIR = r"D:\carved\yolo_baby\images"                       # 학습에 쓴 이미지 (또는 5_detection_train\dataset\images)
DET_MODEL   = r"D:\Code\Monitoring\IoT-Monitoring\media\5_detection_train\output\best\model.pth"    # 파인튜닝 baby
DET_CLASSES = None
